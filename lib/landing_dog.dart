                            ...
                            Container(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  const Text('Kale',style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold,color: Colors.white),),
                                  const SizedBox(height: 10,),
                                  SizedBox(
                                    height: 20,
                                    child: 
                            ...
                            Container(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  const SizedBox(height: 10,),
                                  const Text('Bruno',style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold,color: Colors.white),),
                                  const SizedBox(height: 10,),
                                  SizedBox(
                                    height: 20,
                                    child: 
                              ...
                              child: Column(
                                children: [
                                  ...
                                  const CircleAvatar(
                                   ...
                                   const SizedBox(height: 10,),
                                  const Text('Luna',style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold,color: Colors.white),),
                                   const SizedBox(height: 10,),
                                  SizedBox(
                                    height: 20,
                                    child: 
                              ...
                              child: Column(
                                children: [
                                  ...
                                  const CircleAvatar(
                                   ...
                                   const SizedBox(height: 10,),
                                  const Text('Bella',style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold,color: Colors.white),),
                                   const SizedBox(height: 10,),
                                  SizedBox(
                                    height: 20,
                                    child: 
